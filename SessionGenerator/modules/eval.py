...
async def executor(client: Sakku, message: Message):
...
@Sakku.on_callback_query(filters.regex(r"runtime"))
async def runtime_func_cq(_, cq):
    runtime = cq.data.split(None, 1)[1]
    await cq.answer(runtime, show_alert=True)


@Sakku.on_callback_query(filters.regex("forceclose"))
